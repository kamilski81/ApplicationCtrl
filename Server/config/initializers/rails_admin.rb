# RailsAdmin config file. Generated on March 03, 2014 15:58
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Application Ctrl', 'Admin']
  ...
  # config.excluded_models = ['App', 'Team', 'User', 'Versioning']

  # Include specific models (exclude the others):
  # config.included_models = ['App', 'Team', 'User', 'Versioning']
  ...
  #     configure :versionings, :has_many_association 
  ...
  # config.model 'Versioning' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your versioning.rb model definition
