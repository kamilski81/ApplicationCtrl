...
public class CheckTask extends AsyncTask<Void, Void, Boolean> {
    ...
    protected Boolean doInBackground(Void... params) {
        ...
        try {
            ...
            Log.e("ApplicationCtrl", "Exception getting package info: " + e.getLocalizedMessage());
        ...
        try {
            ...
            Log.e("ApplicationCtrl", "Exception while getting the URL or key from the properties:" + e.getLocalizedMessage());
            // Let the app operate normally when there's a problem with ApplicationCtrl
            returnValue = true;
        }
        ...
        if (server != null && key != null && versionName != null && appName != null) {
            ...
            try {
                ...
                if (response.getStatusLine().getStatusCode() == 200) {
                    ...
                    Log.e("ApplicationCtrl", "Server returned: " + response.getStatusLine().toString());
                ...
                try {
                    ...
                    Log.e("ApplicationCtrl", "Exception reading response body: " + e.getLocalizedMessage());
                }
            } catch (Exception e) {
                Log.e("ApplicationCtrl", "Exception during check: " + e.getLocalizedMessage());
    ...
    protected void onPostExecute(Boolean result) {
        ...
        if (showPopup && !result && url != null && body != null) {
            Intent intent = new Intent(context, ApplicationCtrlDialogActivity.class);
            intent.putExtra(ApplicationCtrlDialogActivity.EXTRA_BODY, body);
            if (type != null) intent.putExtra(ApplicationCtrlDialogActivity.EXTRA_TYPE, type);
            if (encoding != null) intent.putExtra(ApplicationCtrlDialogActivity.EXTRA_ENCODING, encoding);
            intent.putExtra(ApplicationCtrlDialogActivity.EXTRA_URL, url);
